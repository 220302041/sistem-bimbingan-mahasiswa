...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <br />
    <div class='tengah'>
      <a target="_blank" class="btn btn-sm btn-outline-secondary" href="cetak.php">Cetak</a>
      <a target="_blank" class="btn btn-sm btn-outline-secondary" href="export_excel.php">EXPORT KE EXCEL</a>
    </div>
  </div>
